...
class PostControllerTest {
    ...
    void list() throws
        ...
        List<PostGetResponseDTO> dtoList = List.of(responseDTO1,
                                                   responseDTO2);
    ...
    @Test
    void getPost_Parsing_Exception() throws
                                     Exception {
        // Given
        String pathVariable = "e";
        when(postService.get(pathVariable)).thenThrow(ParsingException.class);
    ...
    void test() throws
        ...
        when(postService.update(pathVariable,
    ...
    @Test
    void update_Parsing_Exception() throws
                                    Exception {
        // Given
        String pathVariable = "1";
        PostUpdateRequestDTO requestDTO = PostUpdateRequestDTO.builder()
